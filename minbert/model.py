...
class NewGELU(nn.Module):
    """
    Implementation of the GELU activation function currently in Google BERT repo (identical to OpenAI BERT).
    ...
    def __init__(self, config):
        ...
        if type_given:
            ...
            config.merge_from_dict({
                ...
                # BERT-1
                'openai-BERT':   dict(n_layer=12, n_head=12, n_embd=768),  # 117M params
                # BERT-2 configs
                'BERT2':         dict(n_layer=12, n_head=12, n_embd=768),  # 124M params
                'BERT2-medium':  dict(n_layer=24, n_head=16, n_embd=1024), # 350M params
                'BERT2-large':   dict(n_layer=36, n_head=20, n_embd=1280), # 774M params
                'BERT2-xl':      dict(n_layer=48, n_head=25, n_embd=1600), # 1558M params
                # Gophers
